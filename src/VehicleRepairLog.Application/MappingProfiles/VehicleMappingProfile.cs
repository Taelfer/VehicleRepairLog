    ...
    public class VehicleMappingProfile : Profile
    {
        public VehicleMappingProfile()
        {
            CreateMap<Vehicle, VehicleDto>()
                ...
                .ForMember(vehicleDto => vehicleDto.Name, y => y.MapFrom(vehicle => vehicle.Name))
            ...
            CreateMap<AddVehicleCommand, Vehicle>()
                .ForMember(vehicle => vehicle.Name, y => y.MapFrom(addVehicleCommand => addVehicleCommand.Name))
            ...
            CreateMap<UpdateVehicleCommand, Vehicle>()
                .ForMember(vehicle => vehicle.Name, y => y.MapFrom(updateVehicleCommand => updateVehicleCommand.Name))
